...
<%@ page import="com.bean.NewlyOpenedTicketsBean"%>
...
<title>Newly open ticket</title>
</head>
<body>
<jsp:include page="header.jsp" />
<jsp:include page="footer.jsp" />
<% ArrayList<NewlyOpenedTicketsBean> list = (ArrayList<NewlyOpenedTicketsBean>)request.getAttribute("alldata"); %>
<center>
...
<%
for(NewlyOpenedTicketsBean b: list)
{
%>
<tr>
    <td><%=b.getTicketNO() %></td>
