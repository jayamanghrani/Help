...
public class Queries {
	...
	public static final String getCountDetails="select count(1) as total from UMS_USR_APPL_MAP uuam where uuam.uuam_appl_id='FINANCIALS'and uuam.uuam_appl_approved_status='Y' and (uuam.uuam_end_date is null or uuam.uuam_end_date > sysdate) and uuam.uuam_usr_id = :userId";
}
