...
<%@ page import="com.bean.ResolvedByHoBean"%>
...
<% ArrayList<ResolvedByHoBean> list = (ArrayList<ResolvedByHoBean>)request.getAttribute("alldata"); %>
<center>
