...
<%@ page import="com.bean.SentForClarificationTCS_NEW_OFWeeklyBean"%>
...
<title>Sent for Clarification TCS</title>
</head>
<body>

<jsp:include page="header.jsp" />
<jsp:include page="footer.jsp" />
<% ArrayList<SentForClarificationTCS_NEW_OFWeeklyBean> list = (ArrayList<SentForClarificationTCS_NEW_OFWeeklyBean>)request.getAttribute("alldata"); %>
<center>
...
<%
for(SentForClarificationTCS_NEW_OFWeeklyBean b: list)
{
%>
<tr>
    <td><%=b.getTicketNO() %></td>
    <td><%=b.getAssignOn() %></td>
    <td><%=b.getTicketLoggedDate() %></td>
