...
<%@ page import="com.bean.ResolvedByTicketsBean"%>
...
<title>Resolved by tickets</title>
</head>
<body>
<jsp:include page="header.jsp" />
<jsp:include page="footer.jsp" />
<% ArrayList<ResolvedByTicketsBean> list = (ArrayList<ResolvedByTicketsBean>)request.getAttribute("alldata"); %>
<center>
...
<%
for(ResolvedByTicketsBean b: list)
{
%>
<tr>
    <td><%=b.getTicketNO() %></td>
