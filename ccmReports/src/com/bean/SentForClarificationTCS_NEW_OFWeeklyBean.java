...
public class SentForClarificationTCS_NEW_OFWeeklyBean {
	...
	public SentForClarificationTCS_NEW_OFWeeklyBean(String ticketNO, Date assignOn, Date ticketLoggedDate,
			String problemCategory, String problemType, String problemItem, String problemSummary,
			String problemDescription, String ticketLoggedUserID, String ticketLoggedUsername, String spUserId,
			String spUserName, String role, String department, String status, String userOfficeCode, String priority,
	...
	public SentForClarificationTCS_NEW_OFWeeklyBean() {
		super();
