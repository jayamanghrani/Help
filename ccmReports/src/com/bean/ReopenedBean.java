...
public class ReopenedBean {
	...
	private String numberOfTimeReopen;
	...
	public String getNumberOfTimeReopen() {
		return numberOfTimeReopen;
	}
	public void setNumberOfTimeReopen(String numberOfTimeReopen) {
		this.numberOfTimeReopen = numberOfTimeReopen;
	}
	public ReopenedBean(String ticketNO, Date assignedOn, Date ticketLogDate, String problemCategory,
