...
public class AlfrescoService {
	 ...
	 */
	public EmployeeResponseVO getCacheJson(String json) throws IntegrationTechnicalException {
		String URL = CacheConstants.ALFRESCO_URL;
		//String json = gson.toJson(alfrescoKey);
		EmployeeResponseVO baNCSResponseVO = new EmployeeResponseVO();
		baNCSResponseVO.setJson(invokeClient(json));
		return baNCSResponseVO;
	}
