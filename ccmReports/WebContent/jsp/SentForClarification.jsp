...
<%@ page import="com.bean.SentForClarificationBean"%>
...
<title>Sent For Clarification</title>
</head>
<body>
<jsp:include page="header.jsp" />
<jsp:include page="footer.jsp" />
<% ArrayList<SentForClarificationBean> list = (ArrayList<SentForClarificationBean>)request.getAttribute("alldata"); %>
<center>
...
<%
for(SentForClarificationBean b: list)
{
%>
<tr>
    <td><%=b.getTicketNO() %></td>
