...
public class SentForClarificationBean {
	...
	public SentForClarificationBean(String ticketNO, Date assignOn, Date ticketLoggedDate, String problemCategory,
	...
	public SentForClarificationBean() {
		super();
