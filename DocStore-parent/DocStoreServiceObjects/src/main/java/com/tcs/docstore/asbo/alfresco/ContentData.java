...
public class ContentData implements Serializable, Comparable {
	...
	private String statusOfDocSearch; // added to provide the details to team if any user data is found in the search parameters
	...
	public String toString() {
		...
		builder.append(displayType);
		builder.append(", docMimeType=");
		builder.append(docMimeType);
		builder.append(", docSize=");
		builder.append(docSize);
		...
		builder.append(searchBy);
		builder.append(", statusOfDocSearch=");
		builder.append(statusOfDocSearch);
