...
import com.tcs.docstore.component.util.MessageSource;
...
public class MessageComponentInvoker {
	...
	public DocStoreResponseObject invokeMessageService(
			...
			if (dataMap.containsKey("messageType")) {
				...
				switch (dataMap.get("messageType")) {
					...
					case "MOBILEAPPLINK":
						...
						//LOGGER.info("SMS Sent successfully to: " + dataMap.get("mobileNo"));
						break;
					case "FORGOTPASSWORD":
						this.sendMessage(dataMap);
						break;		
	...
	public void sendMessage(Map<String,String> messageData){
		...
		try {
            ...
            //dataURL = data.replaceAll("\\+", " ");
            LOGGER.info("Actual dataURL ........ : "+dataURL);
