...
public class LoginTransformer {
	 ...
	 * @return
	 */
	public EmployeePortalResponseObject transformLoginAddLink(GetAlfrescoContentResponseASBO getAlfrescoContentResponseASBO)throws IntegrationTransformationException {
		...
		LOGGER.info("getAlfrescoContentResponseASBO.getContentDataList().size()////"+getAlfrescoContentResponseASBO.getContentDataList().size());
		...
		try {
				...
				for (int i = 0; i < getAlfrescoContentResponseASBO.getContentDataList().size(); i++) {
					LOGGER.debug("getAlfrescoContentResponseASBO.getContentDataList()---"+getAlfrescoContentResponseASBO.getContentDataList().get(i));
					...
					{
						LOGGER.debug("getAlfrescoContentResponseASBO.getContentDataList().get(i).getGroup()----"+getAlfrescoContentResponseASBO.getContentDataList().get(i).getGroup());
						if(getAlfrescoContentResponseASBO.getContentDataList().get(i).getGroup()==null/* || getAlfrescoContentResponseASBO.getContentDataList().get(i).getGroup().isEmpty()*/){
							...
							LOGGER.debug("Inside group nullcontentData----"+contentData);
						...
						{
						LOGGER.debug("Inside group else nullcontentData----"+contentData);
