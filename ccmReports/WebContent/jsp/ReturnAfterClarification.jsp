...
<%@ page import="com.bean.ReturnAfterClarificationBean"%>
...
<title>Return after clarification</title>
</head>
<body>
<jsp:include page="header.jsp" />
<jsp:include page="footer.jsp" />

<% ArrayList<ReturnAfterClarificationBean> list = (ArrayList<ReturnAfterClarificationBean>)request.getAttribute("alldata"); %>
<center>
...
<%
for(ReturnAfterClarificationBean b: list)
{
%>
<tr>
    <td><%=b.getTicketNO() %></td>
