...
<%@ page import="com.bean.SentForClarificationHO_NEW_OFWeeklyBean"%>
...
<title>Sent for clarification Ho</title>
</head>
<body>
<jsp:include page="header.jsp" />
<jsp:include page="footer.jsp" />
<% ArrayList<SentForClarificationHO_NEW_OFWeeklyBean> list = (ArrayList<SentForClarificationHO_NEW_OFWeeklyBean>)request.getAttribute("alldata"); %>
<center>
...
<%
for(SentForClarificationHO_NEW_OFWeeklyBean b: list)
{
%>
<tr>
    <td><%=b.getTicketNO() %></td>
