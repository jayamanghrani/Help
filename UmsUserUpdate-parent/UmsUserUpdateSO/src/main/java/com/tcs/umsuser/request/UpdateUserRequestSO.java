...
public class UpdateUserRequestSO extends UmsRequestObject{
	...
	public String toString() {
		return "UpdateUserRequestSO [userId=" + userId + ", title=" + title
				...
				+ ", email=" + email + ", phoneNo=" + phoneNo + ", mobileNo="
				+ mobileNo + ", extension=" + extension + ", ipPhone="
				+ ipPhone + ", startDate=" + startDate + ", endDate=" + endDate
				+ ", supervisorId=" + supervisorId + ", designation="
				+ designation + ", createdBy=" + createdBy + ", createdDate="
