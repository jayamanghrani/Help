...
public class UtilConstants {/** The Constant LOGGER. */
	...
	public static final String CONFIG_PATH ="/wls/middleware/app_config/empConfig.properties";
	...
	/**
	 * The Constant GET_INFO_POLICY_DETAILS.
	 */
	public static final String GET_INFO_POLICY_DETAILS = "getInfoPolicyDetails";
	
	public static final String GET_INFO_ACCEPT_POLICY = "getInfoAcceptPolicy";
	
	// for old document store
