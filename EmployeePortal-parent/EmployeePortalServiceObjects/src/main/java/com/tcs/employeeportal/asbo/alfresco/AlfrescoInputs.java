...
public class AlfrescoInputs implements Serializable{
	...
	/** The is fast moving product. */
	//private String isFastMovingProduct;
	...
	private String matchMethod; // wether you want to match any of the following or match all of the following
	...
	private String searchbytype;  // means seach by docupload date or document publish date
...
public String getProcess() {
	...
	/**
	 * Gets the checks if is fast moving product.
	 *
	 * @return the isFastMovingProduct
	 */
	/*public String getIsFastMovingProduct() {
		return isFastMovingProduct;
	}

	*//**
	 * Sets the checks if is fast moving product.
	 *
	 * @param isFastMovingProduct the isFastMovingProduct to set
	 *//*
	public void setIsFastMovingProduct(String isFastMovingProduct) {
		this.isFastMovingProduct = isFastMovingProduct;
	}*/
	...
	public String toString() {
		...
		builder.append(typeOfContent);
		/*builder.append(", fastMovingProduct=");
		builder.append(isFastMovingProduct);*/
